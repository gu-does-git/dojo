...
- [x] Header with logo (replaced kanji)
- [x] Back button on drill pages
- [x] Pill-shaped toggle switches with sliding indicators
- [x] Fix WanaKana binding for reversed mode
- [x] Reset drill on reverse toggle
- [x] FuriganaText for correct answer display
- [x] Update favicon to accent color
- [x] Clean up unused components (ScoreCard, StatsRow, QuestionHistory)
- [x] Dynamic stats from content collections on homepage
...
- [ ] Time tracking per drill
- [ ] User accounts and progress dashboard
- [ ] Multiple choice drill mode
- [ ] Sentence construction drills
- [ ] Kanji recognition drills
